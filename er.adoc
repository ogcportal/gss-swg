:Title: OGC Geo-Synchronization Standard
:titletext: OGC Geo-Synchronization Standard
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
= OGC Geo-Synchronization Standard
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/IS/gss/1.0
|Internal reference number of this OGC(R) document: 17-031
|Version: 1.0
...
include::clause_06_mediatypes.adoc[]

include::clause_07_abstract.adoc[]

include::clause_08_basics.adoc[]

include::clause_09_workflow.adoc[]

include::clause_10_resources.adoc[]

include::clause_11_discovery.adoc[]

include::clause_12_transaction.adoc[]

include::clause_13_query.adoc[]

include::clause_14_change.adoc[]

include::clause_15_publications.adoc[]

include::clause_16_subscription.adoc[]

include::clause_17_sync.adoc[]
